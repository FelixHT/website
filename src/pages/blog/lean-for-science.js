      ...
      <article className="blog-post">
        ...
        <div className="blog-post__body" ref={bodyRef}>
          ...
          <p>
            ...
            challenge, replication, and scope restriction. A dependency layer
          ...
          <p>
            ...
            Release the resulting graph publicly. Then run a controlled
            evaluation: give newcomers (first-year PhD students, adjacent-field
            postdocs) a set of benchmark tasks—identify the central tension
            around rotational dynamics, find which claims are sensitive to
            smoothing choices, separate genuine theoretical conflict from
            task-regime mismatch—and compare performance with and without the
            claim-dependency graph. Measure time to correct synthesis,
            contradiction detection rate, and methodological sensitivity recall.
          </p>

          <p>
            The result would be informative either way. If the system
            substantially improves navigation and synthesis, then missing
            infrastructure is part of the bottleneck and the approach
            generalizes to any subfield with similar structure. If users with
            the graph do not outperform standard search on contradiction
            detection, methodological sensitivity recall, or time-to-synthesis,
            then the bottleneck is less infrastructural than I hypothesize, and
            future effort should target incentives and institutions instead.
            Empirical science has built data infrastructure and computational
            infrastructure. What it still lacks is claim infrastructure.
            Building that layer for one domain would be a concrete experiment
            in whether improving the memory of the scientific record can
