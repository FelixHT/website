      ...
      <article className="blog-post">
        ...
        <div className="blog-post__body" ref={bodyRef}>
          ...
          <p>
            ...
            <InlineMath tex="\mathbb{R}^{pN}" /> — it is a{" "}
          ...
          <p>
            The Hankel matrix <InlineMath tex="H" /> is large —
            potentially thousands of rows and columns — but its rank is
            small. From{" "}
          ...
          <p>
            ...
            dimensionality, just as it did for PCA — except here the
            matrix is not a covariance matrix but a matrix of
          ...
          <p>
            ...
            singular value contributes little — and if it is below the
          ...
          <p>
            ...
            observation matrix — the linear map from the latent state to
          ...
          <p>
            ...
            alternative. The parallel analysis approach from PCA — compare
            the singular values to those obtained from shuffled data — works
            here too. None of these methods is perfect, but they
            ...
            <Sidenote number={4}>
              ...
              modeling the noise structure explicitly — fitting a
